...
public class ClusteringEval
{
		...
		throws Exception
	{
		...
		try {
			...
			for (String docTopic; (docTopic = br.readLine()) != null;) {

				docLabelOutput.put(docIndex,
					"Topic_" + new Integer(docTopic).toString());
				docIndex++;
			}
		}
		catch (Exception e) {
	...
	public static double[] evaluate(String pathGoldenLabelsFile,
		String pathToTopicFile)
		throws Exception
	{
		...
		// // writer.write("\n---\nMean purity: " + mean(purityValues)
		// // 	+ ", standard deviation: " + stddev(purityValues));

		// // writer.write("\nMean NMI: " + mean(nmiValues)
		// // 	+ ", standard deviation: " + stddev(nmiValues));

		// System.out.println("---\nMean purity: " + mean(purityValues)
		// 	+ ", standard deviation: " + stddev(purityValues));

		// System.out.println("Mean NMI: " + mean(nmiValues)
		// 	+ ", standard deviation: " + stddev(nmiValues));

		// writer.close();
		ClusteringEval dce = new ClusteringEval(pathGoldenLabelsFile, pathToTopicFile);

		double[] result = {dce.computePurity(), dce.computeNMIscore()};
	...
	public static void main(String[] args)
		throws Exception
	{
		double[] results = ClusteringEval.evaluate(args[0], args[1]);
